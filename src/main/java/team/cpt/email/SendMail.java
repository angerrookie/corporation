...
public class SendMail {
	...
	public static void main(String[] args) {
			...
			send.sendAction("激活验证", "-----------", "506570320@qq.com");
	}
	private static String SiteSmtp = "smtp.qq.com";
	private static String SiteEmailAddress = "506570320@qq.com";
	private static String SiteEmailUserName = "506570320";
	private static String SiteEmailPasswd = "xctpbrxszhpdcadf";
}
